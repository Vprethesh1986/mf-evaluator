...
function scoreAnswers(answers) {
  ...
  // Q4 Horizon
  const horizon = parseInt(answers.q3);
        ...
        <div key={step} style={{ animation: `${animDir === "forward" ? "slideIn" : "slideInBack"} .35s ease` }}>
          ...
          {isCombo23 ? (
            <div>
              ...
              <StyledSelect value={answers.q3||""} onChange={v=>handleSelect("q3",v)} options={QUESTIONS[2].options} placeholder={QUESTIONS[2].placeholder} />
            </div>
